    ...
    <SiteLayout>
      <div className="mx-auto max-w-4xl px-6 py-16">
        <header className="text-center">
          ...
          <h1 className="mt-3 font-serif text-5xl text-deep-brown">
            The Pavulum Podcast
          </h1>
        ...
        {episodes.length > 0 ? (
                ...
                <div className="flex-1">
                  ...
                  {(ep.spotifyUrl || ep.appleUrl || ep.youtubeUrl) && (
                    <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-xs text-soft-gold">
                      {ep.spotifyUrl && (
                        <a href={ep.spotifyUrl} target="_blank" rel="noopener noreferrer" className="hover:text-terracotta transition-colors">
                          Spotify →
                        </a>
                      )}
                      {ep.appleUrl && (
                        <a href={ep.appleUrl} target="_blank" rel="noopener noreferrer" className="hover:text-terracotta transition-colors">
                          Apple Podcasts →
                        </a>
                      )}
                      {ep.youtubeUrl && (
                        <a href={ep.youtubeUrl} target="_blank" rel="noopener noreferrer" className="hover:text-terracotta transition-colors">
                          YouTube →
                        </a>
                      )}
                    </div>
          ...
          <div className="mt-20 flex flex-col items-center gap-4 text-center text-charcoal/50">
